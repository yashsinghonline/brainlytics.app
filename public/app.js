  ...
  function renderHome() {
    ...
    container.innerHTML = `
      <div class="site-container animate-fade-up">
        ...
        <div class="card p-6 mb-8" style="padding:1.5rem; margin-bottom:2.5rem; display:flex; flex-direction:column; justify-content:space-between; align-items:center; gap:1.25rem;">
          <div style="display:flex; align-items:center; gap:1rem; width:100%;">
            <div class="stat-pill" style="padding:0.6rem 0.8rem; font-size:24px; border-radius:4px;">🤖</div>
            <div style="flex:1;">
              <div style="display:flex; align-items:center; gap:0.5rem; flex-wrap:wrap;">
                <span class="label" style="color:var(--text); font-size:12px;">Android Mobile APK</span>
                <span class="stat-pill label" style="color:var(--good); font-size:9px;">Direct Download</span>
              </div>
              <p style="color:var(--muted); font-size:13px; margin-top:0.25rem;">
                Get the full Android app directly on your mobile device. Works 100% offline.
              </p>
            </div>
          </div>
          <a href="brainlytics.apk" download="brainlytics.apk" class="btn-play box-fill tap" id="btn-download-apk" style="width:100%; max-width:320px; text-decoration:none; display:inline-flex; align-items:center; justify-content:center; gap:0.5rem; padding:0.9rem 1.5rem; font-weight:600;">
            <span>⬇</span>
            <span>Download Brainlytics APK</span>
          </a>
        </div>
      </div>
    `;
